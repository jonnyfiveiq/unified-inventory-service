...
"""# The main settings for unified_inventory_service.
...
5. Overrides from standard paths.
   - /etc/ansible-automation-platform/unified_inventory_service/
6. Overrides from environment variables prefixed with UNIFIED_INVENTORY_SERVICE_.
...
> or set environment variables prefixed with `UNIFIED_INVENTORY_SERVICE_`.
...
export DJANGO_SETTINGS_MODULE=unified_inventory_service.settings
...
ROOT_URLCONF = "unified_inventory_service.urls"
...
WSGI_APPLICATION = "unified_inventory_service.wsgi.application"
"""WSGI application configuration"""
ASGI_APPLICATION = "unified_inventory_service.asgi.application"
...
LOG_LEVEL = os.environ.get("UNIFIED_INVENTORY_SERVICE_LOG_LEVEL", "INFO").upper()
LOGGING = {
    "version": 1,
...
app_prefix = "UNIFIED_INVENTORY_SERVICE"
"""Application prefix for environment variables filtering."""

os.environ.setdefault("UNIFIED_INVENTORY_SERVICE_MODE", "development")
environment = os.environ.get("UNIFIED_INVENTORY_SERVICE_MODE", "development").lower()
